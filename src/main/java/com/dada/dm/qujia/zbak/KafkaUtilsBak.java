//package com.dada.dm.kafka.kafkademo.util;
//
...
// * @packageName com.dada.dw.md.base.kafka.util
// * @date 2022/4/15 20:17
// */
//@Component
//public class KafkaUtilsBak {
//
//    //    @Value("${spring.kafka.bootstrap-servers}")
//    private String springKafkaBootstrapServers = "192.168.1.9:9092,192.168.1.9:9093,192.168.1.9:9094";
//
